...
User.create!(email: 'pd@test.com', password: '111111', role: 'pd', status: 'active',
             name_cn: '项目总监', name_en: 'pd', date_of_employment: Time.now, candidate_access_limit: 200) unless User.exists?(role: 'pd')
